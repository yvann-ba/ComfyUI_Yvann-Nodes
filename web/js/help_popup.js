...
loadScript('/yvann_web_async/marked.min.js').catch((e) => {
  console.log(e)
})
loadScript('/yvann_web_async/purify.min.js').catch((e) => {
  console.log(e)
})
...
app.registerExtension({
  ...
  if (app.ui.settings.getSettingValue("Yvann.helpPopup") === false) {
    return;
    }
		try {
        ...
        if (nodeData?.category?.startsWith(category)) {
			...
			console.error("Error in registering Yvann.HelpPopup", error);
		}
	},
});
