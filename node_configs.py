...
- `Drums Weights`: Drums-reactive float values for each frame, usable with IPAdapter, CN...
- `Drums Masks`: Drums weights converted to masks usable with LatentNoiseMask, CN, IPadapter...
- `Weights Graph`: Visual Graph of "Drums Weights"
"""
})
...
- `Vocals Weights`: Vocals-reactive float values for each frame, usable with IPAdapter, CN...
- `Vocals Masks`: Vocals weights converted to masks usable with LatentNoiseMask, CN, IPadapter...
- `Weights Graph`: Visual Graph of "Vocals Weights"
"""
})
